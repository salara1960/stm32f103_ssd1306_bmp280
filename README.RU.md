...
```
* Устройство использует программные средства freeRTOS (создается три задачи и одна очередь) :
  - PwmTask - задача, обслуживания светодиодов ws2812.
  - BmpTask - задача, работающая с датчиком bmp280.
  - DefTask - задача, выполняющая функцию main.
